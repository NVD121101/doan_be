...
public class TeacherService {
    ...
    public ResponseEntity<?> editTeacher(EditTeacherRequest editTeacherRequest) {
        try{
            ...
            teacher.setSubject(subject);
            teacher.setSex(editTeacherRequest.getSex());
            teacher.setImage(editTeacherRequest.getImage());
            teacherRepository.save(teacher);
    ...
    public ResponseEntity<?> getTeacherById(Long id) {
        try{
            ...
            if(teacher.isPresent()) {
                ...
                teacherDTO.setSex(teacher.get().getSex());
                teacherDTO.setUserId(teacher.get().getUser().getUserId());
                teacherDTO.setUsername(teacher.get().getUser().getUsername());
    ...
    @Transactional
    public TeacherDTO getTeacherByUserId(){
