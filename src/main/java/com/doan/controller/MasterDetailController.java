...
public class MasterDetailController {
    ...
    @GetMapping("/by-coucil/{coucilId}")
    public ResponseEntity<?> getAllMasterDetailByCoucil(@PathVariable Long coucilId) {
        return masterDetailService.getAllMasterDetaiByCoucil(coucilId);
    }
