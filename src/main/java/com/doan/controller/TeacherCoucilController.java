...
import com.doan.repository.TeacherCoucilRepository;
...
public class TeacherCoucilController {
    ...
    @Autowired
    TeacherCoucilRepository teacherCoucilRepository;
    ...
    public ResponseEntity<?> addTeacherToCouncil(
        ...
        if (optionalTeacher.isPresent() && optionalCouncil.isPresent()) {
            ...
            teacherCoucilRepository.save(teacherCouncil);
    ...
    public ResponseEntity<List<ListTeacherByCouncli>> getTeachersByCouncilId(@PathVariable Long councilId) {
        List<TeacherCoucil> teacherCouncils = teacherCoucilRepository.findByCoucilCoucilId(councilId);
    ...
    public ResponseEntity<List<GetCouncli>> getCouncliByTeacher(@PathVariable Long teacherId) {
        List<TeacherCoucil> teacherCouncils = teacherCoucilRepository.findByTeacherTeacherId(teacherId);
